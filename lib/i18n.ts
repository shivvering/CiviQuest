...
export const UI = {
  en: {
    ...
    play: "← Play",
    // Hero
    heroBadge: "For classes 5–8 · Made in India 🇮🇳",
    heroTitle1: "Civic sense,",
    heroTitle2: "the fun way.",
    heroText:
      "Five levels made for your class — clean streets, safe roads, kind behaviour, saving water, and a grand finale — with Civvy the dolphin cheering you on. Earn XP, keep streaks, collect badges.",
    ...
    mapAllDone: "Crown earned! Replay any level to beat your stars. 👑",
    nextStop: "Next stop:",
    levels5: "5 levels",
    level: "Level",
    ...
    xpEarned: "XP earned",
    newBadge: "New badge:",
    saved: "Your answers were saved. Thank you for helping our study! 💙",
  ...
  hi: {
    ...
    play: "← खेलें",
    heroBadge: "कक्षा 5–8 के लिए · मेड इन इंडिया 🇮🇳",
    heroTitle1: "सिविक सेंस,",
    heroTitle2: "मज़ेदार तरीके से।",
    heroText:
      "आपकी कक्षा के लिए बने पाँच लेवल — साफ़ सड़कें, सुरक्षित रास्ते, अच्छा व्यवहार, पानी की बचत, और एक ग्रैंड फ़िनाले — सिवी डॉल्फ़िन आपका हौसला बढ़ाती रहेगी। XP कमाओ, स्ट्रीक बनाओ, बैज जीतो।",
    ...
    mapAllDone: "ताज जीत लिया! स्टार बढ़ाने के लिए कोई भी लेवल दोबारा खेलो। 👑",
    nextStop: "अगला पड़ाव:",
    levels5: "5 लेवल",
    level: "लेवल",
    bossTag: "लेवल 5 · बॉस",
    ...
    xpEarned: "XP मिले",
    newBadge: "नया बैज:",
    saved: "आपके जवाब सहेज लिए गए। हमारे अध्ययन में मदद के लिए धन्यवाद! 💙",
